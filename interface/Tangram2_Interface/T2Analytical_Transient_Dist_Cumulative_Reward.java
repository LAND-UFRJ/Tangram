...
public class T2Analytical_Transient_Dist_Cumulative_Reward extends javax.swing.JPanel {


  /** Initializes the Form */
  public T2Analytical_Transient_Dist_Cumulative_Reward( T2modelenv ModelEnv ) {
    modelenv = ModelEnv;
    initComponents ();
...
private void initComponents () {//GEN-BEGIN:initComponents
    jP_Cumulative_Reward_Method = new javax.swing.JPanel ();
    ...
    jP_Cumulative_Reward_Method.setLayout (new org.netbeans.lib.awtextra.AbsoluteLayout ());
    jP_Cumulative_Reward_Method.setBorder (new javax.swing.border.LineBorder(java.awt.Color.gray));

      jLabel4.setText ("Reward Name");
      jLabel4.setFont (new java.awt.Font ("Dialog", 1, 10));
  
      jP_Cumulative_Reward_Method.add (jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints (10, 271, -1, -1));
      ...
      jP_Cumulative_Reward_Method.add (jB_File_Chooser, new org.netbeans.lib.awtextra.AbsoluteConstraints (508, 267, 22, 20));
  
  
      jP_Cumulative_Reward_Method.add (jTF_Reward_Name, new org.netbeans.lib.awtextra.AbsoluteConstraints (125, 267, 380, 20));
  
      jLabel5.setText ("Reward Levels");
      jLabel5.setFont (new java.awt.Font ("Dialog", 1, 10));
  
      jP_Cumulative_Reward_Method.add (jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints (10, 297, -1, -1));
  
  
    
        jScrollPane1.setViewportView (jTA_Reward_Levels);
    
      jP_Cumulative_Reward_Method.add (jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints (125, 293, 405, 50));
  

    add (jP_Cumulative_Reward_Method, new org.netbeans.lib.awtextra.AbsoluteConstraints (10, 10, 540, 355));
  ...
  private void initComponentsManual()
  {
    ...
    jP_Cumulative_Reward_Method.add (jP_Probability_and_Intervals, new org.netbeans.lib.awtextra.AbsoluteConstraints (1, 1, 538, 270));
  }
  ...
  public void Evaluate()
  {
    ...
    command = "solv " + modelenv.curmodel + " 8 " + jTF_Reward_Name.getText() + " " + precision;
  ...
  public String Get_Method_Name() {
    return  "Bounded cumulative reward";
  }
...
private javax.swing.JPanel jP_Cumulative_Reward_Method;
