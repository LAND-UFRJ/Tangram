...
public class T2Analytical_Transient_EV_ExpCumRew extends javax.swing.JPanel {

  /** Initializes the Form */
  public T2Analytical_Transient_EV_ExpCumRew( T2modelenv ModelEnv ) {
    modelenv = ModelEnv;
    initComponents ();
  ...
  public void Evaluate()
  {
    ...
    command = "solv " + modelenv.curmodel + " 12 " + jTF_Reward_Name.getText() + " " + precision;
