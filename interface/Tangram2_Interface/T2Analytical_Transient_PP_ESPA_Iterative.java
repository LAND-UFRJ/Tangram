...
public class T2Analytical_Transient_PP_ESPA_Iterative extends javax.swing.JPanel {

  /** Initializes the Form */
  public T2Analytical_Transient_PP_ESPA_Iterative(T2modelenv ModelEnv) {
    modelenv = ModelEnv;
    initComponents ();
...
private void initComponents () {//GEN-BEGIN:initComponents
    ...
    jTF_State_Variable = new javax.swing.JTextField ();
    ...
    add (jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints (10, 350, 520, 100));
    ...
    add (jB_File_Chooser, new org.netbeans.lib.awtextra.AbsoluteConstraints (500, 460, 22, 20));
    ...
    add (jL_State_Variable, new org.netbeans.lib.awtextra.AbsoluteConstraints (20, 460, -1, 20));

    jTF_State_Variable.setEnabled (false);


    add (jTF_State_Variable, new org.netbeans.lib.awtextra.AbsoluteConstraints (130, 460, 360, 20));



    add (jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints (510, 490, 20, 10));
  ...
  private void jTB_Expected_ValueStateChanged (javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_jTB_Expected_ValueStateChanged
    ...
    jTF_State_Variable.setEnabled(state);
  ...
  private void jB_File_ChooserActionPerformed (java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jB_File_ChooserActionPerformed
    if ( fchooser.showDialog(this,"Select") == javax.swing.JFileChooser.APPROVE_OPTION )
      jTF_State_Variable.setText( fchooser.getSelectedFile().getName().substring(new String(modelenv.curmodel).length()+13) );
  ...
  public void Evaluate()
  {
     ...
     try {
          ...
          // System.out.println("Evaluating ESPA Iterative!");

          String command;

          String precision             = method.Get_Precision();
          String max_num_of_iterations = method.Get_Max_Number_Of_Iterations();
          ...
          String state_var =  jTF_State_Variable.getText();

          // System.out.println("Is some field missing?");
          ...
          // System.out.println("Writing output file (.int_iterative)");


          java.io.FileWriter     file   = new java.io.FileWriter( modelenv.curdir + "/" +modelenv.curmodel+".int_iterative" );
          ...
          command = "solv " + modelenv.curmodel + " 16 " + measure + " " + state_var + " "+ method.GetSelectedIterativeMethod() + " "+ precision+ " " +max_num_of_iterations;
...
*/
      ...
      javax.swing.JOptionPane.showMessageDialog(this,"Can't create the file "+ modelenv.curmodel+".int_iterative"+ "\nError -- "+e.toString(),"Error",javax.swing.JOptionPane.ERROR_MESSAGE);
      return;
    }
...
private javax.swing.JTextField jTF_State_Variable;
