...
class IntValue : public ObjectBase<IntValue>
{
public:
    IntValue( const Name &, const IntValue & );

protected:
    friend void initIntValue( void );
...
#define INTVALUE_HELP_MESSAGE \
    "This plugin defines a sample of 32-bit integer values             \n"\
    "    Constructors: intvalue( )                                     \n"\
    "                  intvalue( <file> )                              \n"\
    "    Where:                                                        \n"\
