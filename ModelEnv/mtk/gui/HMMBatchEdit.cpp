...
HMMBatchEdit::HMMBatchEdit( Object     *object,
...
void HMMBatchEdit::buildInterface( void )
{
    buildCaption();
...
void HMMBatchEdit::buildLayout( void )
{
    // Add widgets to layout
    parameters_layout = new QGridLayout( fm_parameters, 6, 2, 5 );     
    ...
    parameters_layout->addWidget( le_batch_size,   2, 1 );
...
void HMMBatchEdit::buildObs( void )
{
...
void HMMBatchEdit::fillStructures( void )
{
    fillPi();
    fillA();
    fillR();
...
void HMMBatchEdit::saveStructures( void )
{
    savePi();
    saveA();
    saveR();
...
void HMMBatchEdit::checkStructures( void )
{
 ...
 */
void HMMBatchEdit::loadObs( void )
{
    // Open dialog
